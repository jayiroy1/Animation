...
float anglebetween(quaternion p, quaternion q){
	float angle, angle1;
	angle =  acos((q.s*p.s+q.x+p.x+q.y*p.y+q.z*p.z));
		angle1= acos((-1*q.s*p.s-q.x+p.x-q.y*p.y-q.z*p.z));
		if(angle<angle1) {
...
point rotate(float rMatrix[3][3] , point p){
...
glPushMatrix();
glTranslatef(g_scene_.animate_.points_[5][0],
			g_scene_.animate_.points_[5][1],
			g_scene_.animate_.points_[5][2]);
...
quaternion qa(g_scene_.animate_.quaternions_[1][0],g_scene_.animate_.quaternions_[1][1],g_scene_.animate_.quaternions_[1][2],g_scene_.animate_.quaternions_[1][3]);
quaternion qb(g_scene_.animate_.quaternions_[0][0],g_scene_.animate_.quaternions_[0][1],g_scene_.animate_.quaternions_[0][2],g_scene_.animate_.quaternions_[0][3]);
float anglea=anglebetween(qb,qa);
