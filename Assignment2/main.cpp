...
point CatmullRoll(float t, struct point p1, struct point p2, struct point p3, struct point p4)
{
...
// set modelviewmatrix
	...
	for(int i = 0; i <  g_scene_.animate_.pnum_; ++i) {
		...
		float t;
							 point u,v;	//Interpolated point
							 point p1(g_scene_.animate_.points_[i][0], g_scene_.animate_.points_[i][1], g_scene_.animate_.points_[i][2]),
									 p2(g_scene_.animate_.points_[(i+1)%8][0], g_scene_.animate_.points_[(i+1)%8][1], g_scene_.animate_.points_[(i+1)%8][2]),
									 p3(g_scene_.animate_.points_[(i+2)%8][0], g_scene_.animate_.points_[(i+2)%8][1], g_scene_.animate_.points_[(i+2)%8][2]),
									 p4(g_scene_.animate_.points_[(i+3)%8][0], g_scene_.animate_.points_[(i+3)%8][1], g_scene_.animate_.points_[(i+3)%8][2]);
